          ...
          <div className="flex flex-col items-center justify-center h-full py-8 text-center">
            ...
            <div className="grid grid-cols-2 gap-2 mt-5 w-full max-w-[320px]">
              {[
                ...
                { text: 'Explore available agents', icon: 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z' },
