  ...
  const handleTestAgent = async () => {
    ...
    try {
      ...
      const task = isAppointment
        ? `You are ${name}, an AI appointment confirmation agent calling on behalf of ${orgName}. You are calling ${contactName} to confirm their ${agentDesc.demoData.appointmentType} appointment scheduled for ${agentDesc.demoData.appointmentDate}. Start with a warm, professional greeting and confirm the appointment details.\n\nIf they want to reschedule: ask whether morning or afternoon works better. Then offer 2-3 specific slots:\n- Morning options: 9:00 AM, 10:30 AM, or 11:00 AM\n- Afternoon options: 2:00 PM, 3:30 PM, or 4:30 PM\nConfirm the exact day and time chosen before ending the call. Be concise, friendly, and helpful. Keep the call under 4 minutes.`
        : isDataVal
