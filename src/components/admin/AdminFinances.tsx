    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">{t.admin.finances.costs}</p>
        </div>
        <select
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200 rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wide">{t.admin.finances.revenue}</span>
          ...
          <div className="mt-3 flex items-center gap-2 text-xs">
            <span className="text-emerald-700">{t.admin.finances.subscriptionRevenue}: ${currentFinance.revenue_subscriptions?.toLocaleString() || 0}</span>
            <span className="text-emerald-600">•</span>
            <span className="text-emerald-700">{t.admin.finances.overageRevenue}: ${currentFinance.revenue_overages?.toLocaleString() || 0}</span>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-red-700 uppercase tracking-wide">{t.admin.finances.costs}</span>
          ...
          <div className="mt-3 flex items-center gap-2 text-xs">
            <span className="text-red-700">{t.admin.finances.blandCost}: ${currentFinance.cost_bland?.toLocaleString() || 0}</span>
            <span className="text-red-600">•</span>
            <span className="text-red-700">{t.admin.finances.openaiCost}: ${currentFinance.cost_openai?.toLocaleString() || 0}</span>
          </div>
        </div>
        ...
        <div className="gradient-bg-subtle border border-[var(--color-primary)]/20 rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-[var(--color-primary)] uppercase tracking-wide">{t.admin.finances.margin}</span>
        ...
        <div className="gradient-bg-subtle border border-[var(--color-primary)]/20 rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-[var(--color-primary)] uppercase tracking-wide">{t.admin.finances.activeCompanies}</span>
            <svg className="w-5 h-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <h4 className="text-sm font-bold text-slate-500 uppercase mb-3">{t.admin.finances.totalCalls}</h4>
          <p className="text-4xl font-bold text-slate-900 mb-2">
            {currentFinance.total_calls_made?.toLocaleString() || 0}
          </p>
          <p className="text-sm text-slate-600">
            {currentFinance.total_minutes_used?.toLocaleString() || 0} {t.common.minutes}
          </p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <h4 className="text-sm font-bold text-slate-500 uppercase mb-3">{t.admin.finances.overageRevenue}</h4>
          <p className="text-4xl font-bold text-slate-900 mb-2">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <h4 className="text-sm font-bold text-slate-500 uppercase mb-3">{t.admin.finances.activeUsers}</h4>
          <p className="text-4xl font-bold text-slate-900 mb-2">
      ...
      {/* Cost Breakdown */}
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h3 className="text-lg font-bold text-slate-900 mb-4">{t.admin.finances.costs}</h3>
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
            <span className="font-semibold text-slate-700">{t.admin.finances.blandCost}</span>
            <span className="text-lg font-bold text-slate-900">
              ${currentFinance.cost_bland?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}
            </span>
          </div>
          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
            <span className="font-semibold text-slate-700">{t.admin.finances.openaiCost}</span>
            <span className="text-lg font-bold text-slate-900">
              ${currentFinance.cost_openai?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}
            </span>
          </div>
          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
            <span className="font-semibold text-slate-700">{t.admin.finances.supabaseCost}</span>
            <span className="text-lg font-bold text-slate-900">
              ${currentFinance.cost_supabase?.toLocaleString(undefined, { minimumFractionDigits: 2 }) || '0.00'}
            </span>
          </div>
          <div className="flex items-center justify-between p-4 bg-slate-900 rounded-lg border border-slate-700">
            <span className="font-bold text-white uppercase">{t.common.total}</span>
