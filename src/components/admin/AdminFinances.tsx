  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black text-slate-900">Financial Dashboard</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-2 border-indigo-200 rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-bold text-indigo-700 uppercase tracking-wide">Gross Margin</span>
          ...
          <p className={`mt-3 text-2xl font-black ${marginColor(currentFinance.gross_margin_percent)}`}>
      ...
      <div className="bg-white rounded-xl border-2 border-slate-200 p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-4 bg-slate-900 rounded-lg border-2 border-slate-700">
