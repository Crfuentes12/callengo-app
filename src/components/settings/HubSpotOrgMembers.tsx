    ...
    return (
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[var(--color-ink)]">HubSpot Org Members</h3>
            <p className="text-xs text-[var(--color-neutral-500)]">Preview and invite HubSpot members to Callengo</p>
          </div>
        </div>
    ...
    return (
      <div className="bg-[var(--color-neutral-50)] rounded-xl border border-[var(--border-default)] p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[var(--color-ink)]">HubSpot Org Members</h3>
            <p className="text-xs text-[var(--color-neutral-500)]">Connect HubSpot to see your org members</p>
          </div>
        </div>
        <p className="text-sm text-[var(--color-neutral-600)] mb-4">
