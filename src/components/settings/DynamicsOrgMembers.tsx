    ...
    return (
      <div className="bg-gradient-to-r from-blue-50/50 to-blue-100/30 rounded-xl border border-blue-200/50 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900">Microsoft Dynamics Members</h3>
            <p className="text-xs text-slate-500">Preview and invite Dynamics members to Callengo</p>
          </div>
        </div>
    ...
    return (
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900">Microsoft Dynamics Members</h3>
            <p className="text-xs text-slate-500">Connect Dynamics to see your org members</p>
          </div>
        </div>
        <p className="text-sm text-slate-600 mb-4">
