  ...
  const loadPlanAndUsage = async () => {
    try {
      ...
      if (subscription?.subscription_plans) {
        setPlan(subscription.subscription_plans as any);
      }
      ...
      setUsageStats({
        ...
        minutesIncluded: usage?.minutes_included || plan?.minutes_included || 0,
        ...
        <div className="bg-white border-2 border-slate-200 rounded-xl p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => onSettingsChange({ ...settings, default_max_duration: parseInt(e.target.value) })}
