            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleUpdateCompany} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-[var(--color-neutral-700)] mb-2 flex items-center gap-2">
                      <span className="w-6 h-6 rounded-md bg-[var(--color-primary-100)] text-[var(--color-primary-600)] flex items-center justify-center text-xs">🏭</span>
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-neutral-700)] mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 rounded-md bg-[var(--color-info-100)] text-[var(--color-info-600)] flex items-center justify-center text-xs">🌐</span>
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-neutral-700)] mb-2 flex items-center gap-2">
                    <span className="w-6 h-6 rounded-md bg-[var(--color-success-100)] text-[var(--color-success-600)] flex items-center justify-center text-xs">📝</span>
