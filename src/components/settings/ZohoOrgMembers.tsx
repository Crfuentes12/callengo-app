    ...
    return (
      <div className="bg-gradient-to-r from-red-50/50 to-red-100/30 rounded-xl border border-red-200/50 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900">Zoho CRM Members</h3>
            <p className="text-xs text-slate-500">Preview and invite Zoho members to Callengo</p>
          </div>
        </div>
    ...
    return (
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900">Zoho CRM Members</h3>
            <p className="text-xs text-slate-500">Connect Zoho CRM to see your org members</p>
          </div>
        </div>
        <p className="text-sm text-slate-600 mb-4">
            ...
            <div key={member.zoho_user_id} className="px-5 py-3.5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {member.role && (
                    <p className="text-xs text-slate-400">{member.role}{member.profile ? ` · ${member.profile}` : ''}</p>
                  )}
                </div>
              </div>
              <div>
