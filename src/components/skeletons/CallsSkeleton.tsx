...
export default function CallsSkeleton() {
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden gradient-bg-subtle rounded-2xl p-8 border border-[var(--color-primary)]/10">
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[0, 1, 2, 3].map((i) => (
              <div key={i} className={`p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-[var(--border-default)]/60 animate-skeleton-slide [animation-delay:${150 + i * 50}ms]`}>
      ...
      {/* Calls Table */}
      <div className="bg-white rounded-2xl border border-[var(--border-default)]/80 overflow-hidden shadow-sm animate-skeleton-slide [animation-delay:420ms]">
        ...
        <div className="px-6 py-4 bg-[var(--color-neutral-50)] border-t border-[var(--border-default)] flex items-center justify-between animate-skeleton-slide [animation-delay:850ms]">
