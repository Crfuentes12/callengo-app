  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl border-2 border-slate-200/80 p-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border-2 border-slate-200/80 overflow-hidden shadow-sm">
          ...
          <div className="p-6 space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="p-4 bg-gradient-to-br from-slate-50 to-white rounded-xl border-2 border-slate-200">
      ...
      <div className="bg-white rounded-2xl border-2 border-slate-200/80 overflow-hidden shadow-sm">
        ...
        <div className="p-6 space-y-4">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="p-5 bg-gradient-to-br from-slate-50 to-white rounded-xl border-2 border-slate-200">
