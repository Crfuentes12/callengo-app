    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-[var(--border-default)] p-12 text-center">
          ...
          <h2 className="text-xl font-bold text-[var(--color-ink)] mb-2">Connect HubSpot</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[var(--color-neutral-50)] border-b border-[var(--border-default)]">
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-[var(--color-neutral-600)]">Lifecycle</th>
                  ...
                  filteredContacts.map((contact) => (
                    <React.Fragment key={contact.id}>
                      ...
                      >
                        ...
                        <td className="px-4 py-3 font-medium text-[var(--color-ink)]">{getContactName(contact)}</td>
                        <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.properties.email || '\u2014'}</td>
                        <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.properties.phone || '\u2014'}</td>
                        <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.properties.company || '\u2014'}</td>
                          ...
                          <td colSpan={9} className="bg-orange-50 px-4 py-0">
                            <div className="pl-14 py-4">
                              <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Job Title</span>
                                  <p className="text-[var(--color-neutral-700)]">{contact.properties.jobtitle || '\u2014'}</p>
                                </div>
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Company</span>
                                  <p className="text-[var(--color-neutral-700)]">{contact.properties.company || '\u2014'}</p>
                                </div>
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Lifecycle Stage</span>
                                  <p className="text-[var(--color-neutral-700)] capitalize">{contact.properties.lifecyclestage || '\u2014'}</p>
                                </div>
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Lead Status</span>
                                  <p className="text-[var(--color-neutral-700)]">{contact.properties.hs_lead_status || '\u2014'}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Mobile Phone</span>
                                  <p className="text-[var(--color-neutral-700)]">{contact.properties.mobilephone || '\u2014'}</p>
                                </div>
                                <div>
                                  <span className="text-[var(--color-neutral-400)] text-xs font-medium">Created Date</span>
                                  <p className="text-[var(--color-neutral-700)]">{contact.properties.createdate ? formatDate(contact.properties.createdate) : '\u2014'}</p>
                                </div>
                              </div>
                            </div>
                          </td>
