    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-[var(--border-default)] p-12 text-center">
          ...
          <h2 className="text-xl font-bold text-[var(--color-ink)] mb-2">Connect Microsoft Dynamics</h2>
                    ...
                    return (
                      <React.Fragment key={contact.contactid}>
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.emailaddress1 || '\u2014'}</td>
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.telephone1 || contact.mobilephone || '\u2014'}</td>
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{contact.parentcustomerid_account?.name || '\u2014'}</td>
                              ...
                              <div className="pl-14 py-4">
                                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                                  <div>
                                    ...
                                    <p className="text-[var(--color-neutral-700)]">{contact.jobtitle || '\u2014'}</p>
                                  </div>
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[var(--color-neutral-700)]">{contact.parentcustomerid_account?.name || '\u2014'}</p>
                                  </div>
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-[var(--color-neutral-700)]">{formatDate(contact.createdon)}</p>
                                  </div>
                                </div>
                              </div>
                            </td>
                    ...
                    return (
                      <React.Fragment key={lead.leadid}>
                        ...
                        >
                          ...
                          <td className="px-4 py-3 font-medium text-[var(--color-ink)]">{name || '\u2014'}</td>
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{lead.emailaddress1 || '\u2014'}</td>
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{lead.telephone1 || lead.mobilephone || '\u2014'}</td>
                          <td className="px-4 py-3 text-[var(--color-neutral-600)]">{lead.companyname || '\u2014'}</td>
                          <td className="px-4 py-3">
                            {statusLabel && (
                            ...
                            <td colSpan={9} className="bg-blue-50/30 px-4 py-0">
                              <div className="pl-14 py-4">
                                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                                  <div>
                                    <span className="text-[var(--color-neutral-400)] text-xs font-medium">Job Title</span>
                                    <p className="text-[var(--color-neutral-700)]">{lead.jobtitle || '\u2014'}</p>
                                  </div>
                                  <div>
                                    <span className="text-[var(--color-neutral-400)] text-xs font-medium">Company</span>
                                    <p className="text-[var(--color-neutral-700)]">{lead.companyname || '\u2014'}</p>
                                  </div>
                                  <div>
                                    <span className="text-[var(--color-neutral-400)] text-xs font-medium">Created</span>
                                    <p className="text-[var(--color-neutral-700)]">{formatDate(lead.createdon)}</p>
                                  </div>
                                </div>
                              </div>
                            </td>
