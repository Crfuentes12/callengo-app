        ...
        <div className="flex-1 overflow-y-auto p-6" style={{ scrollbarGutter: 'stable' }}>
          ...
          {wizardStep === 'agent_test' && selectedPain && (
            <div>
              ...
              <button
                onClick={() => {
                  setWizardStep('pain_selection');
                  setSelectedPain(null);
                }}
                className="flex items-center gap-1.5 mb-4 text-sm text-[var(--color-neutral-500)] hover:text-[var(--color-ink)] transition-colors font-medium"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
