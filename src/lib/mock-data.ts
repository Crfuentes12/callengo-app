...
const CONTACTS_RAW: ContactData[] = [
  ...
  { companyName: 'NovaTech Solutions', contactName: 'James Mitchell', phone: '+14155551001', email: 'james@novatech.io', address: '100 Market St', city: 'San Francisco', state: 'CA', zip: '94105', status: 'Fully Verified', callOutcome: 'Qualified Lead', callAttempts: 2, tags: ['hot-lead', 'saas'], notes: 'Very interested in our platform. Decision maker. Budget approved for Q1.', listIndex: 0 },
  { companyName: 'CloudSync Inc', contactName: 'Sarah Chen', phone: '+14155551002', email: 'sarah@cloudsync.com', address: '200 Pine St', city: 'San Francisco', state: 'CA', zip: '94104', status: 'Fully Verified', callOutcome: 'Interested', callAttempts: 1, tags: ['enterprise', 'cloud'], notes: 'Wants a demo next week. Has a team of 50 agents.', listIndex: 0 },
  { companyName: 'DataFlow Labs', contactName: 'Michael Brown', phone: '+12125551003', email: 'michael@dataflow.dev', address: '350 5th Ave', city: 'New York', state: 'NY', zip: '10118', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['analytics', 'data'], notes: 'Updated email from old domain. Still active customer.', listIndex: 0 },
  ...
  { companyName: 'Swift Commerce', contactName: 'David Kim', phone: '+12065551005', email: 'david@swiftcommerce.io', address: '800 Pike St', city: 'Seattle', state: 'WA', zip: '98101', status: 'Fully Verified', callOutcome: 'Not Interested', callAttempts: 2, tags: ['ecommerce'], notes: 'Already using a competitor. Not switching this year.', listIndex: 0 },
  { companyName: 'GreenCode Software', contactName: 'Lisa Park', phone: '+15125551006', email: 'lisa@greencode.dev', address: '600 Congress Ave', city: 'Austin', state: 'TX', zip: '78701', status: 'Fully Verified', callOutcome: 'Qualified Lead', callAttempts: 1, tags: ['hot-lead', 'devtools'], notes: 'CTO. Looking for automation solutions. Budget $5k/mo.', listIndex: 0 },
  ...
  { companyName: 'MedFirst Clinic', contactName: 'Dr. Patricia Williams', phone: '+13055551011', email: 'pwilliams@medfirst.com', address: '1200 Brickell Ave', city: 'Miami', state: 'FL', zip: '33131', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['clinic', 'confirmed'], notes: 'Appointment confirmed for Feb 10 at 10:00 AM.', listIndex: 1 },
  { companyName: 'Sunrise Health Center', contactName: 'Dr. Mark Johnson', phone: '+16025551012', email: 'mjohnson@sunrisehealth.org', address: '3300 N Central Ave', city: 'Phoenix', state: 'AZ', zip: '85012', status: 'Fully Verified', callOutcome: 'Appointment Rescheduled', callAttempts: 1, tags: ['clinic', 'rescheduled'], notes: 'Rescheduled from Feb 8 to Feb 15 at 2:30 PM. Conflict with surgery.', listIndex: 1 },
  { companyName: 'CarePoint Medical', contactName: 'Nancy Martinez', phone: '+17135551013', email: 'nancy@carepoint.med', address: '6550 Fannin St', city: 'Houston', state: 'TX', zip: '77030', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['clinic', 'confirmed'], notes: 'Confirmed. Patient reminded to bring insurance card.', listIndex: 1 },
  ...
  { companyName: 'Premier Orthopedics', contactName: 'Dr. Susan Clark', phone: '+17705551015', email: 'sclark@premierortho.com', address: '5670 Peachtree Dunwoody Rd', city: 'Atlanta', state: 'GA', zip: '30342', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['specialist', 'confirmed'], notes: 'Confirmed appointment for Feb 12. Pre-op clearance obtained.', listIndex: 1 },
  ...
  { companyName: 'Lakeside Cardiology', contactName: 'Dr. Diana Ross', phone: '+12165551020', email: 'dross@lakesidecardio.com', address: '9500 Euclid Ave', city: 'Cleveland', state: 'OH', zip: '44106', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['cardiology', 'confirmed'], notes: 'Stress test confirmed for Feb 14. Fasting instructions given.', listIndex: 1 },

  // ── Real Estate Agencies (listIndex: 2) ──
  { companyName: 'Pinnacle Realty', contactName: 'Steven Adams', phone: '+17025551021', email: 'steven@pinnaclerealty.com', address: '3900 Paradise Rd', city: 'Las Vegas', state: 'NV', zip: '89169', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['real-estate', 'verified'], notes: 'Updated new office phone and email. Old email was bouncing.', listIndex: 2 },
  { companyName: 'HomeKey Properties', contactName: 'Rachel Green', phone: '+19545551022', email: 'rachel@homekeyprops.com', address: '110 E Broward Blvd', city: 'Fort Lauderdale', state: 'FL', zip: '33301', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['real-estate', 'updated'], notes: 'Confirmed address. Updated agent license number in records.', listIndex: 2 },
  { companyName: 'Metro Living Realtors', contactName: 'Kevin Walsh', phone: '+12025551023', email: 'kevin@metroliving.com', address: '1400 K St NW', city: 'Washington', state: 'DC', zip: '20005', status: 'Wrong Number', callOutcome: 'Wrong Number', callAttempts: 1, tags: ['wrong-number'], notes: 'Number belongs to a different person. Marked for removal.', listIndex: 2 },
  { companyName: 'Coastal Homes Group', contactName: 'Melissa Turner', phone: '+18435551024', email: 'melissa@coastalhomes.net', address: '375 Meeting St', city: 'Charleston', state: 'SC', zip: '29403', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 2, tags: ['real-estate', 'coastal'], notes: 'Second call successful. Verified all contact details. New website URL noted.', listIndex: 2 },
  ...
  { companyName: 'Golden Gate Properties', contactName: 'Laura Bennett', phone: '+14155551026', email: 'laura@goldengateprop.com', address: '580 California St', city: 'San Francisco', state: 'CA', zip: '94104', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['luxury', 'verified'], notes: 'All info current. Added new assistant contact number.', listIndex: 2 },
  ...
  { companyName: 'Heritage Real Estate', contactName: 'Samantha Cole', phone: '+16155551030', email: 'samantha@heritagere.com', address: '150 4th Ave N', city: 'Nashville', state: 'TN', zip: '37219', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['verified', 'updated'], notes: 'Updated address after office relocation. All other data confirmed.', listIndex: 2 },

  // ── E-commerce Stores (listIndex: 3) ──
  { companyName: 'TrendMart Online', contactName: 'Jessica Wang', phone: '+12125551031', email: 'jessica@trendmart.shop', address: '110 Greene St', city: 'New York', state: 'NY', zip: '10012', status: 'Fully Verified', callOutcome: 'Qualified Lead', callAttempts: 1, tags: ['ecommerce', 'hot-lead'], notes: 'High volume seller. 10K orders/month. Very interested in AI calling for customer follow-ups.', listIndex: 3 },
  { companyName: 'FreshGoods Co', contactName: 'Daniel Martinez', phone: '+13105551032', email: 'daniel@freshgoods.co', address: '400 S Figueroa St', city: 'Los Angeles', state: 'CA', zip: '90071', status: 'Fully Verified', callOutcome: 'Interested', callAttempts: 1, tags: ['food', 'subscription'], notes: 'Subscription food box company. Wants to use for delivery confirmation calls.', listIndex: 3 },
  { companyName: 'StyleVault', contactName: 'Olivia Hughes', phone: '+17735551033', email: 'olivia@stylevault.com', address: '900 N Michigan Ave', city: 'Chicago', state: 'IL', zip: '60611', status: 'Fully Verified', callOutcome: 'Not Interested', callAttempts: 2, tags: ['fashion'], notes: 'Not interested at this time. May reconsider in Q3.', listIndex: 3 },
  { companyName: 'PetPal Supplies', contactName: 'Nathan Scott', phone: '+14045551034', email: 'nathan@petpalsupplies.com', address: '3500 Lenox Rd NE', city: 'Atlanta', state: 'GA', zip: '30326', status: 'Fully Verified', callOutcome: 'Interested', callAttempts: 1, tags: ['pets', 'warm-lead'], notes: 'Pet supply store. Interested in appointment scheduling for grooming services.', listIndex: 3 },
  ...
  { companyName: 'ArtisanCraft Hub', contactName: 'Derek Wilson', phone: '+16465551040', email: 'derek@artisancraft.com', address: '250 W Broadway', city: 'New York', state: 'NY', zip: '10013', status: 'Fully Verified', callOutcome: 'Interested', callAttempts: 1, tags: ['handmade', 'marketplace'], notes: 'Artisan marketplace. Interested in validating vendor contact data.', listIndex: 3 },

  // ── Financial Services (listIndex: 4) ──
  { companyName: 'Apex Financial Advisors', contactName: 'Richard Morgan', phone: '+12035551041', email: 'richard@apexfinancial.com', address: '281 Tresser Blvd', city: 'Stamford', state: 'CT', zip: '06901', status: 'Fully Verified', callOutcome: 'Qualified Lead', callAttempts: 2, tags: ['finance', 'hot-lead'], notes: 'Wealth management firm. 200+ clients. Wants AI calling for quarterly check-ins.', listIndex: 4 },
  { companyName: 'SecureWealth Insurance', contactName: 'Linda Harris', phone: '+19085551042', email: 'linda@securewealth.ins', address: '100 Wood Ave S', city: 'Iselin', state: 'NJ', zip: '08830', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['insurance', 'confirmed'], notes: 'Policy review appointment confirmed for Feb 11 at 3pm.', listIndex: 4 },
  { companyName: 'ClearView Accounting', contactName: 'Paul Stewart', phone: '+15085551043', email: 'paul@clearviewcpa.com', address: '1 Beacon St', city: 'Boston', state: 'MA', zip: '02108', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['accounting', 'verified'], notes: 'Tax season prep. Updated business address and confirmed phone.', listIndex: 4 },
  ...
  { companyName: 'Heritage Bank Corp', contactName: 'William Foster', phone: '+12145551045', email: 'wfoster@heritagebank.com', address: '2200 Ross Ave', city: 'Dallas', state: 'TX', zip: '75201', status: 'Wrong Number', callOutcome: 'Wrong Number', callAttempts: 1, tags: ['banking', 'wrong-number'], notes: 'This is a personal number, not business. Need updated business line.', listIndex: 4 },
  { companyName: 'Evergreen Investments', contactName: 'Diana Crawford', phone: '+12065551046', email: 'diana@evergreeninv.com', address: '1201 3rd Ave', city: 'Seattle', state: 'WA', zip: '98101', status: 'Fully Verified', callOutcome: 'Interested', callAttempts: 1, tags: ['investments', 'warm-lead'], notes: 'Interested in lead qualification for their client acquisition pipeline.', listIndex: 4 },
  ...
  { companyName: 'Pacific Mortgage Group', contactName: 'Teresa Lopez', phone: '+18085551048', email: 'teresa@pacificmortgage.com', address: '1001 Bishop St', city: 'Honolulu', state: 'HI', zip: '96813', status: 'Fully Verified', callOutcome: 'Appointment Confirmed', callAttempts: 1, tags: ['mortgage', 'confirmed'], notes: 'Loan review meeting confirmed for Feb 13. Documents checklist sent.', listIndex: 4 },
  { companyName: 'Sterling Tax Services', contactName: 'Andrew Campbell', phone: '+17045551049', email: 'andrew@sterlingtax.com', address: '100 N Tryon St', city: 'Charlotte', state: 'NC', zip: '28202', status: 'Fully Verified', callOutcome: 'Information Updated', callAttempts: 1, tags: ['tax', 'verified'], notes: 'Updated business email and secondary contact. All verified.', listIndex: 4 },
