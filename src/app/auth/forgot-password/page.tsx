...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="animate-fade-in text-center">
        ...
        <p className="text-white/40 text-sm mt-1">Reset link sent to <span className="text-white/70 font-medium">{email}</span></p>
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p className="text-white/40 text-sm mt-1 mb-6">We&apos;ll send you reset instructions</p>
