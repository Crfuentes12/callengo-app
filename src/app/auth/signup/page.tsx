...
export default function SignupPage() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p className="text-slate-400 text-sm mt-1 mb-6">Start automating your sales today</p>
      ...
      <p className="text-center text-xs text-slate-400 mt-4">
        ...
        <Link href="/auth/login" className="text-[var(--color-primary)] font-semibold hover:opacity-80">Sign in</Link>
      </p>
    </div>
  );
}
