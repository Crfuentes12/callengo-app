    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-[var(--border-default)] overflow-hidden">
        <div className="p-8 text-center max-w-xl mx-auto">
          ...
          <h3 className="text-xl font-bold text-[var(--color-ink)] mb-2">{t.team.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left mb-8">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-neutral-50)] border border-[var(--border-subtle)]">
              ...
              <div>
                <p className="text-sm font-semibold text-[var(--color-ink)]">{t.team.inviteMember}</p>
                <p className="text-xs text-[var(--color-neutral-500)] mt-0.5">Add colleagues to your organization and assign roles</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-neutral-50)] border border-[var(--border-subtle)]">
              ...
              <div>
                <p className="text-sm font-semibold text-[var(--color-ink)]">Coordinate campaigns</p>
                <p className="text-xs text-[var(--color-neutral-500)] mt-0.5">Run parallel campaigns and share results across the team</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-neutral-50)] border border-[var(--border-subtle)]">
              ...
              <div>
                <p className="text-sm font-semibold text-[var(--color-ink)]">Share insights</p>
                <p className="text-xs text-[var(--color-neutral-500)] mt-0.5">Analytics and call data visible to your entire organization</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-neutral-50)] border border-[var(--border-subtle)]">
              ...
              <div>
                <p className="text-sm font-semibold text-[var(--color-ink)]">Import from CRM</p>
                <p className="text-xs text-[var(--color-neutral-500)] mt-0.5">Bring people from Salesforce, HubSpot, or any CRM into your org</p>
              </div>
            </div>
          </div>
          ...
          <p className="text-[11px] text-[var(--color-neutral-400)] mt-3">Business plan includes 3 seats. Teams plan includes 5+ seats.</p>
        </div>
      </div>
    </div>
  );
