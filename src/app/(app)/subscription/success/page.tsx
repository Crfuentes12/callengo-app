  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        {/* Success Icon */}
        <div className="mx-auto w-20 h-20 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-md mb-6">
        ...
        {verifying && (
          <p className="text-sm text-[var(--color-primary)] mb-2 flex items-center justify-center gap-2">
            <span className="w-3 h-3 border-2 border-[var(--color-primary)]/30 border-t-[var(--color-primary)] rounded-full animate-spin inline-block"></span>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 gradient-bg hover:opacity-90 text-white font-semibold text-sm rounded-xl shadow-sm transition-all duration-200"
        >
          Go to Dashboard
