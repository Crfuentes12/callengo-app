    ...
    <div className="min-h-screen gradient-bg-subtle flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-[var(--color-ink)] mb-3 tracking-tight">Create your account</h1>
          <p className="text-[var(--color-neutral-500)] text-lg">Start automating your calls today</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-md p-8 border border-[var(--border-default)]">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center gap-3">
              ...
              <div className={`h-1 w-20 rounded-full transition-all ${
                step === 'company' ? 'gradient-bg' : 'bg-[var(--color-neutral-200)]'
              }`}></div>
              <div className={`flex items-center justify-center w-10 h-10 rounded-full font-semibold transition-all ${
                step === 'company'
                  ? 'gradient-bg text-white shadow-sm'
          ...
          {step === 'account' ? (
            ...
            <form onSubmit={handleCompanySubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-semibold text-[var(--color-neutral-700)] mb-2">
                  Company Website <span className="text-[var(--color-neutral-400)]">(optional)</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-[var(--color-neutral-400)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  disabled={loading}
                  className="flex-1 py-3.5 border border-[var(--border-strong)] text-[var(--color-neutral-700)] font-semibold rounded-xl hover:bg-[var(--surface-hover)] transition-all disabled:opacity-50"
                >
                  ← Back
                </button>
                <button
