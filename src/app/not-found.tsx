  ...
  return (
    <div className="min-h-screen gradient-bg-subtle flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        {/* Callengo Logo */}
        <div className="mx-auto w-14 h-14 rounded-2xl gradient-bg flex items-center justify-center shadow-md mb-8">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 mt-8 px-6 py-3 gradient-bg hover:opacity-90 text-white font-semibold text-sm rounded-xl shadow-sm transition-all duration-200"
        >
