...
export async function GET(request: NextRequest) {
  try {
    ...
    // Sanitize return_to to prevent open redirect — must be a relative path starting with /
    const safeReturnTo = (return_to && return_to.startsWith('/') && !return_to.startsWith('//'))
