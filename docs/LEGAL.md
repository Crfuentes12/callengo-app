...
All of these are now tracked via the new `openai_usage_logs` table and use separate API keys per feature (`OPENAI_API_KEY_CALL_ANALYSIS`, `OPENAI_API_KEY_CONTACT_ANALYSIS`, `OPENAI_API_KEY_CALI_AI`).
