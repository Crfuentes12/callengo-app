...
| `fav_voices` | `JSONB` | — | YES | A JSONB array of Bland AI voice IDs that the user has marked as favorites. These appear at the top of the voice selection dropdown in the [[Agent]] configuration modal, making it faster to find preferred voices across the 66-voice catalog. Example: `["2f9fdbc7-4bf2-4792-8a18-21ce3c93978f", "37b3f1c8-a01e-4d70-b251-294733f08371"]`. |
